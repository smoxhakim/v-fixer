...
All Markdown documentation for this repository lives in **`docs/`** (this file included). See [README.md](README.md) for an index of every doc.
...
- **Backend API notes for admins:** [MESSAGE_FOR_BACKEND_TEAM.md](MESSAGE_FOR_BACKEND_TEAM.md)
- **Backend ↔ frontend contract:** [BACKEND_FRONTEND_OVERVIEW.md](BACKEND_FRONTEND_OVERVIEW.md) — what the API exposes today and what the Next app expects.
